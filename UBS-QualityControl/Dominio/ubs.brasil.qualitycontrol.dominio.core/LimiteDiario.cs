...
{
    public class LimiteDiario : Operacao<LimitePerfilRisco>
    {
        private static dynamic repositorioFabrica;
        private static dynamic fabricaLogOperacao; 

        public LimiteDiario(RepositorioModeloQC repositorioModeloQC, RepositorioModeloWM_DB repositorioModeloWM_DB)
        {
            fabricaLogOperacao = OperacaoFabrica.CriarOperacaoLog<OperacaoLog>(repositorioModeloQC, repositorioModeloWM_DB);     

            repositorioFabrica = RepositorioFabrica.CriarRepositorio<LimitePerfilRisco, RepositorioLimiteDiario>(repositorioModeloQC, repositorioModeloWM_DB);                                                       
        }
        ...
        private void GravarLogOperacao(List<LimitePerfilRisco> limitePerfilRisco, string acao)
        {
            ...
            foreach (LimitePerfilRisco limite in limitePerfilRisco)
            {
                ...
                logOperacao.nomeTipoFuncionalidade = "Limite Diário";
                ...
                logOperacao.txDescricao = string.Concat("Perfil Risco: ", limite.codPerfilRisco,
                                                        ...
                                                        ", Data Inicial: ", limite.dtIniVigencia.ToString("dd/MM/yyyy"),
                                                        ", Data Final: ", limite.dtFimVigencia.ToString("dd/MM/yyyy"));       
