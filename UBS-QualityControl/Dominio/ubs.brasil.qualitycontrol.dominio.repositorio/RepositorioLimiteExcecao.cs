...
{
    public class RepositorioLimiteExcecao : Repositorio<LimitePerfilRisco>
    {        
        private readonly RepositorioModeloQC dbQC;
        private readonly RepositorioModeloWM_DB dbWM_DB;

        public RepositorioLimiteExcecao(RepositorioModeloQC repositorioModeloQC, RepositorioModeloWM_DB repositorioModeloWM_DB)
        {
            ...
            foreach(LimitePerfilRisco limitePerfil in limitePerfilRisco)
            {
                var resQC = from lpr in dbQC.LimitePerfilRisco                        
                            where
                              ...
                              (lpr.dtIniVigencia.Equals(limitePerfil.dtIniVigencia) || lpr.dtFimVigencia.Equals(limitePerfil.dtFimVigencia)) &&
