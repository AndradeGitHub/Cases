...
{
    [TestClass]
    public class RepositorioCarteiraTest
    {
        ...
        private IRepositorio<Carteira> repositorioFabrica;        
        ...
        [TestCategory("CARTEIRA"), TestMethod]
        public void DeveConsultarTodasAsCarteiras()
        {
            repositorioFabrica = new RepositorioCarteira(_repositorioModeloQC, _repositorioModeloWM_DB);

            List<Carteira> lstRet = repositorioFabrica.SelecionarTudo();
