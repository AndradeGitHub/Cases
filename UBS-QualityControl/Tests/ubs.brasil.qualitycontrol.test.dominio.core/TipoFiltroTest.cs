...
namespace ubs.brasil.qualitycontrol.test.dominio.core
{
    ...
    public class TipoFiltroTest
    {
        ...
        private IOperacao<TipoDeFiltro> operacoesFabrica;
        ...
        //{
        //    operacoesFabrica = new TipoFiltro(_repositorioModeloQC, _repositorioModeloWM_DB);
        //    List<TipoDeFiltro> lstRet = operacoesFabrica.SelecionarTudo();
