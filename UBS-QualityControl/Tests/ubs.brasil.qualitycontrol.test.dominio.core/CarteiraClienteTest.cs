...
{
    [TestClass]
    public class CarteiraClienteTest
    {
        ...
        private IOperacao<Carteira> operacoesFabrica;
        ...
        //public void DeveConsultarTodasAsCarteirasCliente()
        //{
        //    operacoesFabrica = new CarteiraCliente(_repositorioModeloQC, _repositorioModeloWM_DB);
        //    List<Carteira> lstRet = operacoesFabrica.SelecionarTudo();
