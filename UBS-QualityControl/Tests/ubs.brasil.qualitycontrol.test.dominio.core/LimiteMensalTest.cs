...
namespace ubs.brasil.qualitycontrol.test.dominio.core
{
    ...
    public class LimiteMensalTest
    {
        ...
        public void DeveGravarLimiteMensalMOCK()
        {
            operacoesFabrica = new LimiteMensal(_mockRepositorioModeloQC.Object, _mockRepositorioModeloWM_DB.Object);

            Assert.AreEqual(0, operacoesFabrica.Gravar(PopularEntidadeGravar()));
        }

        [TestCategory("LIMITE MENSAL"), TestMethod]
        public void DeveAlterarLimiteMensalMOCK()
        {                                
            operacoesFabrica = new LimiteMensal(_mockRepositorioModeloQC.Object, _mockRepositorioModeloWM_DB.Object);
        ...
        [TestCategory("LIMITE MENSAL"), TestMethod]
        public void DeveApagarLimiteMensalMOCK()
        {
            operacoesFabrica = new LimiteMensal(_mockRepositorioModeloQC.Object, _mockRepositorioModeloWM_DB.Object);
        ...
        {
            operacoesFabrica = new LimiteMensal(_repositorioModeloQC, _repositorioModeloWM_DB);

            Assert.AreEqual(PopularEntidadeGravar().Count(), operacoesFabrica.Gravar(PopularEntidadeGravar()));
        }

        [TestCategory("LIMITE MENSAL"), TestMethod]
        public void NAO_DeveGravarLimiteMensal_REGISTRO_EXISTENTE()
        {
            operacoesFabrica = new LimiteMensal(_repositorioModeloQC, _repositorioModeloWM_DB);
        ...
        [TestCategory("LIMITE MENSAL"), TestMethod]
        public void NAO_DeveAlterarLimiteMensal_CHAVE_EXISTENTE()
        {
        ...
        //[TestCategory("LIMITE MENSAL"), TestMethod]
        //public void DeveSelecionarRegistroLimiteMensal()
        //{
        ...
        {
            LimitePerfilRisco limitePerfilRisco = new LimitePerfilRisco();
            limitePerfilRisco.codLimitePerfilRisco = 3;
            ...
            limitePerfilRisco1.codLimitePerfilRisco = 4;
            ...
            limitePerfilRisco1.inDiarioMensal = "M";
